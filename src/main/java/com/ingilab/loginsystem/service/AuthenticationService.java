...
public class AuthenticationService {
  ...
  public ForgotPasswordResponse forgotPassword(ForgotPasswordRequest forgotPasswordRequest) {
    ...
    public ForgotPasswordResponse verifyOtpAndResetPassword(VerifyOtpRequest verifyOtpRequest) {
      ...
      if (!verifyOtpRequest.getNewPassword().equals(verifyOtpRequest.getConfirmPassword())) {
        ...
        var validOtp = otpRepository.findValidOtp(
                verifyOtpRequest.getEmail(), // Use the email from VerifyOtpRequest
        ...
        var user = repository.findByEmail(verifyOtpRequest.getEmail()) // Use the email from VerifyOtpRequest
